...
@StepScope
@Log4j2
public class TeamUsersProcessor implements ItemProcessor<TeamUserTaskProgress, TeamUsers> {

	@Autowired
	private TeamUsersService teamUsersService;

	@Override
	public TeamUsers process(TeamUserTaskProgress item) throws Exception {
